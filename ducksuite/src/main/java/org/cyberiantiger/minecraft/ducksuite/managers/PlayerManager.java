...
import org.cyberiantiger.minecraft.ducksuite.events.NewPlayerJoinEvent;
...
public class PlayerManager {
    ...
    private static void createNewPlayer(final ProxiedPlayer player) {
        ...
        if (ConfigManager.spawn.SpawnNewPlayerAtNewspawn && SpawnManager.NewPlayerSpawn != null) {
            ...
            ProxyServer.getInstance().getScheduler().schedule(DuckSuite.instance, new Runnable() {
    ...
    public static List<GSPlayer> getPlayersByIP(String ip) {
        ...
        if (ip == null) {
            ...
            DuckSuite.instance.getLogger().severe("getPlayersByIP() ip is null");
            return null;
        }
