...
import org.cyberiantiger.minecraft.ducksuite.profile.Profile;
import org.cyberiantiger.minecraft.ducksuite.tasks.DatabaseUpdateRowUUID;
...
public class Utilities {
    ...
    {
        ProxyServer.getInstance().getScheduler().runAsync(DuckSuite.instance, new DatabaseUpdateRowUUID(id, playerName));
    }
}
