...
import org.cyberiantiger.minecraft.ducksuite.tasks.GlobalAnnouncements;
import org.cyberiantiger.minecraft.ducksuite.tasks.ServerAnnouncements;
        ...
        if (ConfigManager.announcements.Enabled) {
            ...
            if (!global.isEmpty()) {
                ...
                if (interval > 0) {
                    ...
                    ScheduledTask t = proxy.getScheduler().schedule(DuckSuite.instance, g, interval, interval, TimeUnit.SECONDS);
            ...
            for (String server : proxy.getServers().keySet()) {
                ...
                if (!servermes.isEmpty()) {
                    ...
                    if (interval > 0) {
                        ...
                        ScheduledTask t = proxy.getScheduler().schedule(DuckSuite.instance, s, interval, interval, TimeUnit.SECONDS);
                        announcementTasks.add(t);
                    }
                }
            }
